...
<html>
  <head>
    ...
    <style>
      ...
      .checkoutBody{height: 300vh;background:var(--col7);}
        ...
        <div class="checkoutContainerInr flex jcsb bor">
          ...
          <div class="checkoutMainTrunk bor">
            ...
            <table class="checkoutTable box w100">
              ...
              <!-- for each list start  -->
              <tr><td>Crocodile T-Shirt</td><td>32</td><td>1</td><td>NRS 4530</td><td class="flexmid"><a href="#" class="checkoutRemoveLink flex bor"><img src="../icons/times.png" alt="" class="w100 bor" ></a></td></tr>
              <tr><td>Crocodile T-Shirt</td><td>32</td><td>1</td><td>NRS 4530</td><td class="flexmid"><a href="#" class="checkoutRemoveLink flex bor"><img src="../icons/times.png" alt="" class="w100 bor" ></a></td></tr>
              <tr><td>Crocodile T-Shirt</td><td>32</td><td>1</td><td>NRS 4530</td><td class="flexmid"><a href="#" class="checkoutRemoveLink flex bor"><img src="../icons/times.png" alt="" class="w100 bor" ></a></td></tr>
              <tr><td>Crocodile T-Shirt</td><td>32</td><td>1</td><td>NRS 4530</td><td class="flexmid"><a href="#" class="checkoutRemoveLink flex bor"><img src="../icons/times.png" alt="" class="w100 bor" ></a></td></tr>
              <!-- for each list end  -->
          ...
          <div class="checkoutCheckoutTrunk bor">
            ...
            <form action="" class="checkoutForm flex fdc bor" method="post">
              ...
              <div class="checkoutFormInputCrate bor">
                <input type="text" class="checkoutFormInputSloth" placeholder="your name..." name="name" required>
              </div>
              <div class="checkoutFormTextSloth" form-text="email">Email</div>
              <div class="checkoutFormInputCrate bor">
                <input type="text" class="checkoutFormInputSloth" placeholder="your email..." name="email" required>
              </div>
              <div class="checkoutFormTextSloth" form-text="email">Address</div>
              <div class="checkoutFormInputCrate bor">
                <input type="text" class="checkoutFormInputSloth" placeholder="your address..." name="address" required>
              </div>
              ...
              <div class="checkoutFormInputCrate bor">
                <input type="text" class="checkoutFormInputSloth" placeholder="your phone number..." name="number" required>
              </div>
              ...
              <div class="checkoutFromTotalTrunk flex fdc">
                ...
                <div class="checkoutFormTotalCrate flex jcsb" data-total-crate="subtotal">
                  ...
                  <div class="checkoutFormTotalText" data-side="right">NRS 3000</div>
                </div>
